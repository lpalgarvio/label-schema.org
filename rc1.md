...
| `keywords` | `org.label-schema.keywords = "application, database, nosql"` | A comma-separated list of keywords. May contain up to 300 characters. |
| `license` | `org.label-schema.license = "GPL-3.0"` | License of the image. Must conform to the [SPDX license specification](https://spdx.org/licenses). |
...
| `vcs-branch` | `org.label-schema.vcs-branch = "master"` | The branch of the source code from which this image was built. |
| `vcs-tag` | `org.label-schema.vcs-tag = "v1.0"` | The tag of the source code from which this image was built. |
...
| `authors.<username>.role` | `org.label-schema.authors.<username>.role = "DevOps"` | The role of `<username>` that authored this image. Multiple username keys can exist. |
...
| `os-id` | `org.label-schema.os-id = "ubuntu"` | Identifier of the operating system or distribution. In case of building a base image, ie with no parent, use "custom". |
| `os-version-id` | `org.label-schema.os-version-id = "14.04"` | Identifier of the operating system or distribution version. In case of building a base image, ie with no parent, use "none". |
| `os-architecture` | `org.label-schema.os-architecture = "amd64"` | Identifier of the operating system architecture. |
